...
import { createProfile, uploadAvatar, hasAvatar } from '../../actions/profile';
import { connect } from 'react-redux';
import PropTypes from 'prop-types'


const EditProfile = ({ createProfile, uploadAvatar,hasAvatar, profile: { profile, loading }, history }) => {
  ...
  return (
    <Fragment>
      ...
      <form onSubmit={onSubmit} className="form" encType='multipart/form-data'>
        ...
        <div className="my-2">
          <button onClick={() => setSocial(!social)} type="button" className="btn btn-light">
...
EditProfile.propTypes = {
  ...
  hasAvatar: PropTypes.func.isRequired,
}

export default connect(mapStateToProps, { createProfile, uploadAvatar, hasAvatar })(withRouter(EditProfile));
