...
const CreateProfile = ({ createProfile, uploadAvatar, hasAvatar,  history }) => {
...
export default connect(null, { createProfile, uploadAvatar, hasAvatar })(withRouter(CreateProfile))
